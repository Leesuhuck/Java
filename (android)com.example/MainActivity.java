...
public class MainActivity extends AppCompatActivity {
    ...
    public void A(String str, String btr, String ctr){
        ...
        value_p_1 = (int)inte_p;

        value_p_2 = (int)mmoney_p;
    }
    ...
    public void B(String str, String btr, String ctr){
        ...
        double son_d = pow(1 + (inter_w / 12), Double.valueOf(ctr).doubleValue()); //str
        double mother = pow(1 + (inter_w / 12), Double.valueOf(ctr).doubleValue()); //str
        mother = mother - 1;
        ...
        for (int i = 1; i < (ex_ctr + 1); i++) { //ctr
            inte_w = round(ex_str * inter_w / ex_ctr); //str, ctr
    ...
    public void C(String str, String btr, String ctr) {
        ...
        double ex_ctr_m = Double.valueOf(ctr).doubleValue();
        for (int i = 1; i < ex_ctr_m; i++) {
            sum_m += minte;
        }
        sum_m += minte;

        int total_m = (int)(minte + ex_ctr_m);

        value_m_1 = minte;
        value_m_2 = (int)ex_str_m;
